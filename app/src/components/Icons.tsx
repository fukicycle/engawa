...
export const LeafIcon: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => (
  <svg
    ...
    {...props}
  >
    {/* Elegant, clean simple organic leaf silhouette with subtle fill */}
    <path d="M12 2c0 0-8 4-8 10a8 8 0 0 0 16 0c0-6-8-10-8-10z" fill="currentColor" fillOpacity="0.08" />
    <path d="M12 2v18" />
    <path d="M12 8c1.5-1 3-1 3-1M12 12c-1.5-1-3-1-3-1M12 15c1.5-1 3-1 3-1" />
  </svg>
);
